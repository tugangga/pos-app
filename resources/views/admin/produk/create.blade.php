        ...
        <!-- <div class="space-y-12"> -->
            <div class="border-b border-gray-900/10 pb-6 mb-4">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                    <div class="md:col-span-2 lg:col-span-1">
                        ...
                        <div class="mt-2 ">
                            <input id="kode" type="text" name="kode" value="{{ old('kode') }}" class="input-form-control" autofocus/>
                        </div>
                        <div class="text-xs text-green-900 font-light">kosongkan jika dibuat sistem</div>
                        @error('kode')
                ...
                <div class="" x-data="{pilihSatuan:''}" >
                    ...
                    <div class="mt-2">
                        <input id="satuan" type="text" name="satuan" :value="pilihSatuan" value="{{ old('satuan') }}"   class="input-form-control uppercase" />
                    </div>                   
                    <div class="text-xs text-green-900 font-light ">pilih opsi jika sudah ada</div>
                    @error('satuan')
                        <div class="text-xs text-red-900 font-light">{{ $message }}</div>
                    @enderror                                        
    
                    <div class="mt-2 grid grid-cols-1">
                        <select tabindex="-1"  x-model="pilihSatuan" class="select-form-control " >
                ...
                <div class="" x-data="{pilihKategori:''}">
                    ...
                    <div class="mt-2">
                        <input id="kategori" type="text" name="kategori" :value="pilihKategori" value="{{ old('kategori') }}" class="input-form-control uppercase" />
                    </div>
                    ...
                    <div class="mt-2 grid grid-cols-1">
                        <select tabindex="-1" x-model="pilihKategori"
                ...
                <div class="">
                    ...
                    <div class="mt-2">
                        <input id="harga_beli" type="number" name="hbeli" value="{{ old('hbeli',0) }}" class="input-form-control" />
                    </div>
                    @error('hbeli')
                        <div class="text-xs text-red-900 font-light">{{ $message }}</div>
                    @enderror    
                ...
                <div class="">
                    ...
                    <div class="mt-2">
                        <input id="harga_jual" type="number" name="hjual" value="{{ old('hjual',0) }}" class="input-form-control" />
                    </div>
                    @error('hbeli')
                        <div class="text-xs text-red-900 font-light">{{ $message }}</div>
                    @enderror
                ...
                <div class="">
                    ...
                    <div class="mt-2">
                        <input id="re-stock" type="number" name="restock" value="{{ old('restock', 10) }}" class="input-form-control" />
                    </div>
                    @error('restock')
                        <div class="text-xs text-red-900 font-light">{{ $message }}</div>
                    @enderror
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-6">
                <div class="">
                    ...
                    <div class="mt-2">
                        <input id="quantity_awal" type="number" name="qawal" x-model.debounce="qawal" id="qawal"  value="{{ old('qawal',0) }}" class="input-form-control" />
                    </div>
                    @error('qawal')
                    <div class="text-xs text-red-900 font-light">{{ $message }}</div>
                    @enderror
