<header class="bg-white outline-1 outline-gray-900/5">
      <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
        ...
        <el-popover-group class="hidden lg:flex lg:gap-x-12">
          <!-- home -->
          <a href="/dashboard" class="text-sm/6 font-semibold text-gray-900">Home</a>
          <!-- end of home -->

          <!-- Produk -->
          <div class="relative">
            <button popovertarget="desktop-menu-produk" class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" >
              Produk
              <svg
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <el-popover id="desktop-menu-produk" anchor="bottom" popover class="pop-over" >
              <div class="p-4">
                <div
                ...
                >
                  ...
                  <div class="">
                    <a href="{{ route('produk.create') }}" class="block font-semibold text-gray-900">
                      Tambah Data
                ...
                >
                  ...
                  <div class="">
                    <a href="{{ route('produk') }}" class="block font-semibold text-gray-900">
                      Manajemen Data
                      <span class="absolute inset-0"></span>
                    </a>
                  </div>
          ...
          <div class="relative">
            <button
              popovertarget="desktop-menu-user"
              class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900"
            >
              User
              <svg
            ...
            >
              <div class="p-4">
                ...
                >
                  ...
                  <div class="">
                    <a href="{{ route('user.create') }}" class="block font-semibold text-gray-900">
                      Tambah Data
                      <span class="absolute inset-0"></span>
                    </a>
                  </div>
                ...
                >
                  ...
                  <div class="">
                    <a href="{{ route('user') }}" class="block font-semibold text-gray-900">
                      Manajemen Data User
                      <span class="absolute inset-0"></span>
                    </a>
                  </div>
                    ...
                    <div class="-mx-3">
                      ...
                      >
                        <a
                          ...
                          class="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-normal text-gray-900 hover:bg-gray-50"
                          >Tambah Data</a
                        >
                        <a
                          href="{{ route('produk') }}"
                          class="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-normal text-gray-900 hover:bg-gray-50"
                          >Manajemen Data Produk</a
                        >
                        <a
                          href="#"
                          class="block rounded-lg py-2 pr-3 pl-6 text-sm/7 font-normal text-gray-900 hover:bg-gray-50"
